...
//  3 - Used "append" in the timeblock container based off the way the password elements appended in the first JS exercise. Loads the timeblock rows and save button
